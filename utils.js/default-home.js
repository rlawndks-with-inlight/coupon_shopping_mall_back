...
//
// 프론트 src/data/default-banners.js 의 **seed 표시가 붙은 것들**과 같아야 한다.
// (프론트는 '섹션 0개일 때 렌더 시점 폴백'용, 여기는 '개설 시 실제 저장'용 — 둘 다 같은 이미지를 쓴다)
//
// ⚠ 프론트의 '고를 수 있는 기본 배너 목록'은 업종별 사진까지 20장이 넘는다.
//   여기 목록을 그 전체와 맞추면 안 된다 — 개설만 해도 배너가 20장 넘게 깔린다.
//   자동으로 깔리는 것은 아래 6장으로 고정한다. 목록에 사진을 추가해도 여기는 그대로 둔다.
