...
import benefitNoticeRoutes from "./benefit_notice.route.js";
import orderFormRoutes from "./order_form.route.js";
...
router.use("/benefit-notices", benefitNoticeRoutes);
...
router.use("/product-faq", productFaqRoutes);
