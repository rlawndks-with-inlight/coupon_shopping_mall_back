        ...
        try {
            ...
            if (is_copy_brand_setting == 1) {//브랜드 기본세팅 복사 원할시
                let result = await updateQuery('brands', {
                    ...
                    company_name: sender_brand?.company_name,
                    pvcy_rep_name: sender_brand?.pvcy_rep_name,
                    ceo_name: sender_brand?.ceo_name,
                    addr: sender_brand?.addr,
                    resident_num: sender_brand?.resident_num,
                    business_num: sender_brand?.business_num,
                    phone_num: sender_brand?.phone_num,
                    fax_num: sender_brand?.fax_num,
